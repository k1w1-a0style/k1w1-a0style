...
- Zuletzt abgeschlossen: **Patch 418 V1**
...
- Patch 418 V1: trust/docs consolidation sweep — refresh the core architecture docs to the real post-417 state, move all currently known open follow-ups into `docs/TODO.md`, and explicitly queue a repo-wide MD cleanup as the next documentation task
