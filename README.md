...
- Zuletzt abgeschlossen: **Patch 458**.
...
- Patch 458 schließt die bestätigten ChatScreen-/Chat-Flow-Restpunkte konservativ: Attachment-Flow kommuniziert jetzt ehrlich (nur Dateiname/Metadaten statt impliziter Inhaltsanalyse), Chat-History wird direkt beim Append per Retention begrenzt, und Focus-Cleanup verhindert hängende Pending-/Modal-Zustände beim Verlassen des ChatScreens.
