...
import { minimalDefaultFor, minimalAppJson, defaultEasIgnore } from "./diagnostics/templates/defaults";
import { patchPackageJson } from "./diagnostics/templates/patchers/packageJson";
import { patchAppJson } from "./diagnostics/templates/patchers/appJson";
import { patchAppConfigJs } from "./diagnostics/templates/patchers/appConfigJs";
import { patchEasJson } from "./diagnostics/templates/patchers/easJson";
import {
  DEFAULT_TOOLCHAIN,
  PNG_1x1_BASE64,
  REQUIRED_ASSETS_P0,
