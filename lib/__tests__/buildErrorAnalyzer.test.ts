  ...
  describe("analyzeLogs", () => {
      ...
      const logs: LogEntry[] = [
        {
          ...
          message: "Cannot find module 'react-native-maps'",
          level: "error",
        },
      ];
    ...
    it("should limit relevant logs to 3 entries", () => {
      const logs: LogEntry[] = [
        {
          timestamp: "2025-01-01T00:00:00Z",
          message: "EXPO_TOKEN error 1",
          level: "error",
        },
        {
          timestamp: "2025-01-01T00:01:00Z",
          message: "EXPO_TOKEN error 2",
          level: "error",
        },
        {
          timestamp: "2025-01-01T00:02:00Z",
          message: "EXPO_TOKEN error 3",
          level: "error",
        },
        {
          timestamp: "2025-01-01T00:03:00Z",
          message: "EXPO_TOKEN error 4",
          level: "error",
        },
        {
          timestamp: "2025-01-01T00:04:00Z",
          message: "EXPO_TOKEN error 5",
          level: "error",
        },
      ];
      const result = BuildErrorAnalyzer.analyzeLogs(logs);
