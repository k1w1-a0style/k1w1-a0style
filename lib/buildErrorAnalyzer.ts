  ...
  private static errorPatterns = [
    {
      ...
      suggestion:
        "Überprüfe ob EXPO_TOKEN als Secret in GitHub Actions konfiguriert ist. Generiere einen neuen Token auf expo.dev/accounts/[account]/settings/access-tokens",
    ...
    },
    {
      ...
      suggestion:
        'Führe "npm ci" lokal aus und überprüfe package.json und package-lock.json. Stelle sicher, dass alle Dependencies kompatibel sind.',
    ...
    },
    {
      ...
      suggestion:
        "Überprüfe android/build.gradle und stelle sicher, dass alle Android Dependencies und SDK Versionen kompatibel sind. Prüfe auch die JDK Version.",
...

    {
      ...
      suggestion:
        'Führe "npm run lint" und "tsc --noEmit" lokal aus. Behebe alle TypeScript Fehler vor dem Build.',
    ...
    },
    {
      ...
      suggestion:
        'Erhöhe die resourceClass in eas.json auf "large" oder optimiere die Bundle-Größe durch Code-Splitting und Tree-Shaking.',
    ...
    },
    {
      ...
      suggestion:
        "Der Build dauert zu lange. Optimiere Build-Zeit durch Caching in eas.json oder verwende eine größere resourceClass.",
...

    {
      ...
      suggestion:
        'Stelle sicher, dass alle importierten Module in package.json definiert sind. Führe "npm install" aus und committe node_modules nicht.',
    ...
    },
    {
      ...
      suggestion:
        "Das ist meist ein temporäres Problem. Starte den Build erneut. Bei wiederholten Fehlern überprüfe die Netzwerk-Konfiguration.",
    ...
    },
    {
      ...
      suggestion:
        'Führe ESLint aus: "npm run lint". Überprüfe die Syntax in den angegebenen Dateien.',
  ...
  static analyzeLogs(logs: LogEntry[]): ErrorAnalysis[] {
    ...
    if (analyses.length === 0 && errorLogs.length > 0) {
      analyses.push({
        ...
        suggestion:
          "Überprüfe die Logs unten für Details. Häufige Ursachen: Dependencies, TypeScript Fehler, oder Konfigurationsprobleme.",
