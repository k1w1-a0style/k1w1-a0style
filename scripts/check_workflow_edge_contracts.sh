...
require_fixed "$TRIGGER_EDGE" 'allowCiBearer: false'
...
require_fixed "$CHECK_EDGE" 'allowCiBearer: false'
...
require_fixed "$ARTIFACT_EDGE" 'allowCiBearer: false'
...
require_fixed "$RUNS_EDGE" 'allowCiBearer: false'
...
require_fixed "$LOGS_EDGE" 'allowCiBearer: false'
...
require_fixed "$DISPATCH_EDGE" 'allowCiBearer: false'
