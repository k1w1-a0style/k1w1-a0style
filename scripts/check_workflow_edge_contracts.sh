...
require_fixed "$TRIGGER_ROUTE_CORE" 'requireWorkflowOperatorJwtRoleWithVerifiedActor(req, "trigger-eas-build")'
...
require_fixed "$RUNS_EDGE" 'requireWorkflowOperatorJwtRoleWithVerifiedActor(req, "github-workflow-runs")'
require_fixed "$LOGS_EDGE" 'adminSecretEnv: "K1W1_EDGE_WORKFLOW_ADMIN_KEY"'
require_fixed "$LOGS_EDGE" 'requireWorkflowOperatorJwtRoleWithVerifiedActor(req, "github-workflow-logs")'
