- [x] Patch 472 (2026-03-17): AI-/Request-Follow-up finalisiert — `runOrchestrator` hat jetzt eine echte Hard-Deadline über den gesamten Request-Lauf (kein Timeout-Reset pro Retry/Rotation), abort-konsistent mit klarem Timeout-Resultat; gezielte Timeout-Regression angepasst.
