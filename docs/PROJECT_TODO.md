...
- [ ] **355 `: any` Annotationen** — systematischer TS-Safety-Debt, besonders in `contexts/` (Patch 327/328/329: weitere Catch-Pfade + Terminal/BuildStatus + ConnectionsScreen ohne zentrale `any`-Props)
