...
- [x] **SettingsScreen/AIContext-Restpunkte (Quality/Retention/Validation)** — Quality-Mode setzt effektive Modelle mit, Retention-Limit ist im Privacy-Flow editierbar/persistierbar, Gemini-Key-Prefix-Validation ergänzt und Settings-`any`-Hotspots reduziert ✅ *(patch 463)*
