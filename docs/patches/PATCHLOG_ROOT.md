...
## Recent (kompakt)
- Patch 472: Follow-up auf PR #288 — `runOrchestrator` erzwingt nun eine echte Hard-Deadline über den gesamten Aufruf (kein Timeout-Reset pro Rotation/Retry), bleibt abort-konsistent und liefert bei Budgetablauf einen klaren Timeout-Fehler; gezielte Timeout-Regression entsprechend angepasst.
