...
export const AVAILABLE_MODELS: Record<AllAIProviders, ModelInfo[]> = {
  ...
  openai: [
    model({ id: 'gpt-5.4-pro', label: 'GPT-5.4 Pro', description: 'Große Repos, Architektur, Agentic Workflow', tier: 'paid', persona: 'quality', bestFor: 'Code + Review', contextWindow: '128k', pricePerMillion: '$15 / $45', availabilityLabel: 'Ja', codingStrength: 5 }),
    model({ id: 'gpt-5.4', label: 'GPT-5.4', description: 'Solides Reasoning, Multi-File, nativer Tool-Use', tier: 'credit', persona: 'balanced', bestFor: 'Allround', contextWindow: '128k', pricePerMillion: '$10 / $30', availabilityLabel: 'Ja', codingStrength: 4 }),
    model({ id: 'gpt-5.3-codex', label: 'GPT-5.3 Codex', description: 'Letztes dediziertes Codex-Modell, guter Fallback', tier: 'credit', persona: 'balanced', bestFor: 'Fallback Codex', contextWindow: '128k', pricePerMillion: '$2 / $6', availabilityLabel: 'Ja', codingStrength: 4 }),
    ...
    model({ id: 'gpt-5.4-nano', label: 'GPT-5.4 nano', description: 'Sehr leicht, pfeilschnelle Inline-Fixes', tier: 'free', persona: 'speed', bestFor: 'Mini-Tasks', contextWindow: '128k', pricePerMillion: '$0 (Quota)', availabilityLabel: 'Ja', codingStrength: 2 }),
  ...
  gemini: [
    model({ id: 'gemini-3.1-pro', label: '3.1 Pro', description: 'Bestes Repo- & Kontext-Verständnis (bis 2M Tokens)', tier: 'paid', persona: 'quality', bestFor: 'Quality/Review', contextWindow: '2M', pricePerMillion: '$2 / $12', availabilityLabel: 'Ja', codingStrength: 5 }),
    ...
    model({ id: 'gemini-3.1-flash-lite', label: '3.1 Flash Lite', description: 'Extrem leicht, ideal für hohes Volumen', tier: 'free', persona: 'speed', bestFor: 'Speed', contextWindow: '1M', pricePerMillion: '$0 (Quota)', availabilityLabel: 'Ja', codingStrength: 2 }),
  ...
  groq: [
    ...
    model({ id: 'llama-4-scout-17b-16e', label: 'Llama 4 Scout', description: 'Neu & leicht', tier: 'credit', persona: 'balanced', bestFor: 'Balanced', contextWindow: '128k', pricePerMillion: '$0 (Limit)', availabilityLabel: 'Ja', codingStrength: 3 }),
  ...
  huggingface: [
    ...
    model({ id: 'deepseek-ai/DeepSeek-V3.2', label: 'DeepSeek V3.2', description: 'Starkes Reasoning', tier: 'credit', persona: 'quality', bestFor: 'Reasoning', contextWindow: 'varies', pricePerMillion: '$7 / $18', availabilityLabel: 'Ja', codingStrength: 5 }),
