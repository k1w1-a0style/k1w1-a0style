  ...
  return (
    <View style={styles.modeList}>
      {modes.map((m: ModelInfo) => {
        ...
        const persona =
          (personaTokens as any)[m.persona] || personaTokens.balanced;
        ...
        return (
          ...
          >
            <View style={styles.modeHead}>
              <Text
                style={[styles.modeTitle, isSelected && styles.modeTitleActive]}
              >
                {m.label}
              </Text>
      ...
      {PROVIDER_IDS.map((id) => {
        ...
        return (
          <TouchableOpacity
            ...
            style={[
              styles.providerTile,
              isSelected && styles.providerTileActive,
            ]}
          >
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.agentToggleHint}>
            Wenn „Aus“, wird nur der Generator genutzt (kein zweiter
            Review-Pass).
          </Text>
              ...
              (m) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.qualityBtn,
                      isActive && styles.qualityBtnActive,
                    ]}
                  >
                    <Text
                      style={[
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.tokenPreview}>
            Hinweis: Anzeige “LIMIT” kommt nur, wenn dein Rate-Limiter/Status
            das meldet.
          </Text>
        </View>
