...
export const styles = StyleSheet.create({
  ...
  buttonText: { color: theme.palette.text.primary, fontWeight: "600" },
  ...
  // ✅ active text: schwarz auf neon
  filterButtonTextActive: { fontSize: 12, color: "#000", fontWeight: "600" },
  ...
  recentPillText: { fontSize: 11, color: theme.palette.text.primary },
