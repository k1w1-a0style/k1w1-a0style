...
describe("promptEngine context prioritization", () => {
  ...
  it("limits builder output to the currently requested block when budget indicates a large task scope", () => {
    ...
    expect(userInstruction).toContain("Scope wirkt groß");
    expect(userInstruction).toContain("Liefere nur den aktuell angeforderten Block");
