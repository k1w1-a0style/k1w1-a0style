...
export const PROVIDER_RUNTIME_MODEL_MAP = freezeProviderRuntimeMap({
  ...
  openai: {
    'gpt-5.3-codex': DIRECT('gpt-5.3-codex'),
  ...
  gemini: {
    ...
    'gemini-3.1-flash-lite': MAPPED('gemini-2.5-flash-lite', 'Gemini API compatibility alias'),
  ...
  groq: {
    ...
    'llama-4-scout-17b-16e': MAPPED('llama-4-scout-17b-16e-instruct', 'Groq runtime canonical scout id'),
  ...
  huggingface: {
    ...
    'deepseek-ai/DeepSeek-V3.2': MAPPED('deepseek-ai/DeepSeek-V3.2-Speciale', 'Hugging Face router alias'),
