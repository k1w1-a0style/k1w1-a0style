...
- 2026-03-18: Patch 480: Schritt-3-Nachprüfung minimal vervollständigt — `validateBeforeSave(...)` blockiert jetzt fachlich ungültige manuelle EAS-Project-IDs (UUID-Guard vor Save/Link), und Chat-Bestätigungstexte zeigen Ownership-/Blocker-Gründe weiterhin explizit statt nur Zähler/Skip-Listen; N6/K8/K9 im aktuellen Stand nicht bestätigt.
