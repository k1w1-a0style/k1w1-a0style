...
- 2026-03-18: Patch 478: Schritt-2-Restpunktprüfung gezielt weitergeführt — NEW-12 bestätigt und im App-Orchestrator minimal behoben (`x-goog-api-key` Header statt URL-Query-Param), gezielte Regression ergänzt; NEW-3 als realer Architektur-/Isolations-Trade-off ohne kleinen sauberen Ersatz eingeordnet, NEW-6/NEW-7/NEW-5 im aktuellen Stand nicht bzw. nicht pauschal bestätigt.
